...
public class SelectionToolsPanel extends JPanel {
	...
	public SelectionToolsPanel(AppState appState) {
		...
		Bindings.bind(chkAutoSelectMajorThird, pm.getModel(AppState.AUTO_SELECT_MAJOR_THIRD));
		add(chkAutoSelectMajorThird, cc.xy(x, y));

		x += 2;
		JCheckBox chkAutoSelectFifth = new JCheckBox("sélectionne la quinte");
		Bindings.bind(chkAutoSelectFifth, pm.getModel(AppState.AUTO_SELECT_FIFTH));
